...
const Hero8 = () => {
    ...
    return (
       <div className="p-5 text-start mt-6">
            {/* Title */}
            <img src={Text} alt="Services" className="mx-auto mb-8 hidden lg:block" />
            ...
            <div className="w-full h-full relative hidden lg:block">
                ...
                <div className="absolute top-[40%] left-[5%] z-10 text-white py-10 px-12 bg-[var(--goat-black)] rounded-2xl w-[90%] sm:w-[70%] md:w-[60%] lg:w-[90%]">
                    ...
                    <div className="text-[10px] text-white leading-relaxed w-auto">
            ...
            <div className="w-full relative lg:hidden">
                ...
                <img
                    src={LeftFooterImg}
                    alt="Left Footer Background"
                    className="absolute left-0 top-[-25px] h-full object-contain"
                />
                
                <img
                    src={RightFooterImg}
                    alt="Right Footer Background"
                    className="absolute right-0 bottom-0 h-[75%] object-contain z-20"
                />
                
                <div className="absolute inset-0 flex items-center justify-center z-10 w-full">
                        <div className="bg-[var(--goat-black)] rounded-2xl px-4 py-5 sm:px-6 sm:py-6 mx-4 max-w-md w-full flex flex-row sm:flex-row gap-6 items-center justify-center">
