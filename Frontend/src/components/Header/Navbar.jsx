...
const Navbar = () => {
  ...
  return (
        <div className="relative h-[12vh] w-full flex items-center justify-between px-4 md:px-0 lg:px-0">
        <div className="flex items-center justify-between w-full md:hidden">
            <button
            onClick={() => setMenuOpen(!menuOpen)}
            className="text-[var(--goat-red)]"
            >
            <Menu size={28} />
            </button>
            ...
            <Phone size={26} className="text-[var(--goat-red)]" />
        </div>
        ...
        {menuOpen && (
            <div className="absolute top-[12vh] left-0 w-full bg-black bg-opacity-95 text-white flex flex-col items-center py-6 space-y-4 md:hidden z-50">
